                        ...
                        eventMessage: {
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    newsletterName: "X | VinZephyrine-EscannoR",
                                    newsletterJid: "120363425547320365@newsletter",
                                    serverMessageId: 1
                                }
                            },
            ...
            const msg = await this.utils.generateWAMessageFromContent(jid, {
                pollResultSnapshotMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardingScore: 1,
                        forwardedNewsletterMessageInfo: {
                            newsletterName: pollData.newsletter.newsletterName || "120363425547320365@newsletter",
        ...
        async handleOrderMessage(content, jid, quoted) {
            ...
            const Haha = await this.utils.generateWAMessageFromContent(jid, {
                orderMessage: {
                    ...
                    token: "VINZEPHYRINE_EXAMPLE_TOKEN",
